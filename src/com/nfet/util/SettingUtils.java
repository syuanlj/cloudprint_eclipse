...
import com.nfet.CommonAttributes;
import com.nfet.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		try {
			File cloudprintXmlFile = new ClassPathResource(CommonAttributes.CLOUDPRINT_XML_PATH).getFile();
			Document document = new SAXReader().read(cloudprintXmlFile);
			List<Element> elements = document.selectNodes("/cloudprint/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			try {
				...
				fileOutputStream = new FileOutputStream(cloudprintXmlFile);
