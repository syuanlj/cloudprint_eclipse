...
import com.nfet.entity.BaseEntity.Save;
...
public class AdminController extends BaseController {
	...
	public String save(User admin, Long[] roleIds, RedirectAttributes redirectAttributes) {
	...
	public String update(User admin, Long[] roleIds, RedirectAttributes redirectAttributes) {
		admin.setRoles(new HashSet<Role>(roleService.findList(roleIds)));
		if (!isValid(admin)) {
			return ERROR_VIEW;
		}
		User pAdmin = adminService.find(admin.getId());
		if (pAdmin == null) {
			return ERROR_VIEW;
		}
