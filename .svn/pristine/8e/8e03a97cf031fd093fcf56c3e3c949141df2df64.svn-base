...
$().ready(function() {
	...
	[@compress single_line = true]
		var printedCountData = '<graph caption="${message("admin.system.name")}${message("admin.statistic.receive.hour")}" subcaption="00:00 ~ 24:00" decimalPrecision="0" formatNumberScale="0" chartRightMargin="30" showValues="1" yAxisMaxValue="100" baseFontSize="12">
...
<body>
	...
	<form id="inputForm" action="receive_hour.ehtml" method="get">
