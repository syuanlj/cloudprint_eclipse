...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.ehtml">${message("admin.path.index")}</a> &raquo; ${message("admin.productCategory.list")}
	</div>
	<div class="bar">
	...
	<table id="listTable" class="list">
		...
		[#list productCategoryTree as productCategory]
			<tr>
				...
				<td>
					<a href="view.ehtml?id=${productCategory.id}">[${message("admin.common.view")}]</a>
					<a href="edit.ehtml?id=${productCategory.id}">[${message("admin.common.edit")}]</a>
