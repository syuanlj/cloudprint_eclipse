...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.ehtml">${message("admin.path.index")}</a> &raquo; ${message("admin.shop.edit")}
	</div>
	<form id="inputForm" action="update.ehtml" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="name" class="text" value="${shop.name}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="order" class="text" value="${shop.order}" maxlength="9" />
				</td>
			</tr>
			<tr>
				<th>
