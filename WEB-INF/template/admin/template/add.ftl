...
<title>${message("admin.template.add")}</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.ehtml">${message("admin.path.index")}</a> &raquo; ${message("admin.template.add")} 
	</div>
	<form id="inputForm" action="save.ehtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<textarea name="content" style="width: 100%; height: 500px; padding: 0px;"></textarea>
				</td>
			</tr>
			<tr>
				<th>
