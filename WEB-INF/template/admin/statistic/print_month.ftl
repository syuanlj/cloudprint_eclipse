...
$().ready(function() {
	...
	[@compress single_line = true]
		var printedCountData = '<graph caption="${message("admin.system.name")}${message("admin.statistic.print.month")}" subcaption="${beginDate?string(dateFormat)} ~ ${endDate?string(dateFormat)}" decimalPrecision="0" formatNumberScale="0" chartRightMargin="30" showValues="1" yAxisMaxValue="100" baseFontSize="12">
...
<body>
	...
	<form id="inputForm" action="print_month.ehtml" method="get">
