...
$().ready(function() {
	...
	[@compress single_line = true]
		var printedCountData = '<graph caption="${product.sn}${message("admin.statistic.product.date")}" subcaption="${beginDate?string(dateFormat)} ~ ${endDate?string(dateFormat)}" decimalPrecision="0" formatNumberScale="0" chartRightMargin="30" showValues="1" yAxisMaxValue="100" baseFontSize="12">
...
<body>
	...
	<form id="inputForm" action="product_date.ehtml" method="get">
